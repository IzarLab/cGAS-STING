...
### Load dataset
cell_bender_mat <- Read_CellBender_h5_Mat(file_name = "/Users/zackbrodtman/Documents/jobwork/CUIMC/JG02/LC/LC30/feature_bc_matrix_bent_filtered.h5")
...
sweep.list <- paramSweep_v3(seu, PCs = 1:35)
...
# Run doubletFinder
seu <- doubletFinder_v3(seu, PCs = 1:35, pN = 0.25, pK = pK, nExp = nExp.poi.adj, reuse.pANN = FALSE)
...
new.cluster.ids <- c('Plasma', 'Other', 'M2 Macrophage Polarization', 'Other', 'Cycling', 'Fibroblasts','dCAF', 'Cycling B Cells', 'Other', 'Other', 'Other')
...
### Save objects
saveRDS(seu, file = 'LC30_seu_processed.rds')

### write pdf reports
pdf(file = "LC30_plots.pdf")

...
### Load dataset
cell_bender_mat <- Read_CellBender_h5_Mat(file_name = "/Users/zackbrodtman/Documents/jobwork/CUIMC/JG02/LC/LC33/feature_bc_matrix_bent_filtered.h5")
...
sweep.list <- paramSweep(seu, PCs = 1:45)
...
seu <- FindNeighbors(seu, dims = 1:45)
...
# Run doubletFinder
seu <- doubletFinder(seu, PCs = 1:45, pN = 0.25, pK = pK, nExp = nExp.poi.adj, reuse.pANN = FALSE)
...
new.cluster.ids <- c('Unknown', 'Unknown', 'Unknown', 'Unknown', 'Unknown', 'Unknown', 'Unknown', 'Unknown', 'Unknown')
...
saveRDS(seu, file = 'LC33_seu_processed.rds')

### write pdf reports
pdf(file = "LC33_plots.pdf")

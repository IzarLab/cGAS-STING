...
### Load dataset
cell_bender_mat <- Read_CellBender_h5_Mat(file_name = "/Users/zackbrodtman/Documents/jobwork/CUIMC/JG02/LC/LC25/feature_bc_matrix_bent_filtered.h5")
...
sweep.list <- paramSweep_v3(seu, PCs = 1:30)
...
# Run doubletFinder
seu <- doubletFinder_v3(seu, PCs = 1:30, pN = 0.25, pK = pK, nExp = nExp.poi.adj, reuse.pANN = FALSE)
...
new.cluster.ids <- c('Fibroblasts', 'Fibroblasts', 'Fibroblasts', 'Other')
...
### Save objects
saveRDS(seu, file = 'LC25_seu_processed.rds')

### write pdf reports
pdf(file = "LC25_plots.pdf")

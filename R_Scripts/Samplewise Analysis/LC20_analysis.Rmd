...
### Load dataset
cell_bender_mat <- Read_CellBender_h5_Mat(file_name = "/Users/zackbrodtman/Documents/jobwork/CUIMC/JG02/LC/LC20/feature_bc_matrix_bent_filtered.h5")
...
sweep.list <- paramSweep_v3(seu, PCs = 1:28)
...
seu <- FindNeighbors(seu, dims = 1:28)
...
# Run doubletFinder
seu <- doubletFinder_v3(seu, PCs = 1:28, pN = 0.25, pK = pK, nExp = nExp.poi.adj, reuse.pANN = FALSE)
...
b_cell_types <- c("Plasma.cells",	#"Activated.B.cells",
                  "Cycling.B.cells",	"Stromal.cells",	"Follicular.B.cells",	"Germinal.center.B.cells", "Memory.B.cells",	"Naive.B.cells",	"Transitional.B.cells",	#"Large.pre-B.cells",
...
new.cluster.ids <- c('Naive B Cells', 'Naive B Cells', 'Cycling Endothelial', 'Cycling Endothelial','Cardiomyocytes','Other','Cardiomyocytes','B cells','Naive B Cells','Endothelial', 'Fibroblasts', 'Other' ,'Other')
...
saveRDS(seu, file = 'LC20_seu_processed.rds')

### write pdf reports
pdf(file = "LC20_plots.pdf")

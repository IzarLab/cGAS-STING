...
### Load dataset
cell_bender_mat <- Read_CellBender_h5_Mat(file_name = "/Users/zackbrodtman/Documents/jobwork/CUIMC/JG02/LC/LC191/feature_bc_matrix_bent_filtered.h5")
...
sweep.list <- paramSweep_v3(seu, PCs = 1:45)
...
# Run doubletFinder
seu <- doubletFinder_v3(seu, PCs = 1:45, pN = 0.25, pK = pK, nExp = nExp.poi.adj, reuse.pANN = FALSE)
...
new.cluster.ids <- c('Fibroblasts', 'Fibroblasts', 'Endothelial Cells', 'Fibroblasts','Macrophages')
...
### Save objects
saveRDS(seu, file = 'LC191_seu_processed.rds')

### write pdf reports
pdf(file = "LC191_plots.pdf")
...
p <- readRDS("/Users/zackbrodtman/Downloads/LC191_cnv (1).rds")

...
### Load dataset
cell_bender_mat <- Read_CellBender_h5_Mat(file_name = "/Users/zackbrodtman/Documents/jobwork/CUIMC/JG02/LC/LC26/feature_bc_matrix_bent_filtered.h5")
...
#sum(is.nan(seu@assays$RNA$data))
...
sweep.list <- paramSweep_v3(seu, PCs = 1:24)
...
seu <- FindNeighbors(seu, dims = 1:24)
...
# Run doubletFinder
seu <- doubletFinder_v3(seu, PCs = 1:24, pN = 0.25, pK = pK, nExp = nExp.poi.adj, reuse.pANN = FALSE)
...
myeloid_types <- c(#"MacrophagesM1",   'MacrophagesM2',
  ...
  "MonoT_Doublet",	"Monocyte",	"Inflammatory_monocytes",	"resident_monocytes")
...
new.cluster.ids <- c('Plasma Cells', 'Cycling Endothelial Cells', 'Cycling Endothelial Cells', 'Other','Myeloid','Fibroblasts','Memory B Cells','Fibroblasts','Other', 'Other', 'Myeloid')
...
### Save objects
saveRDS(seu, file = 'LC26_seu_processed.rds')

### write pdf reports
pdf(file = "LC26_plots.pdf")

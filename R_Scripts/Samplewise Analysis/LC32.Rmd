...
### Load dataset
cell_bender_mat <- Read_CellBender_h5_Mat(file_name = "/Users/zackbrodtman/Documents/jobwork/CUIMC/JG02/LC/LC32/feature_bc_matrix_bent_filtered.h5")
...
new.cluster.ids <- c('Unknown', 'Unknown')
...
saveRDS(seu, file = 'LC32_seu_processed.rds')

### write pdf reports
pdf(file = "LC32_plots.pdf")

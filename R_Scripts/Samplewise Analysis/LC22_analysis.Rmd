...
### Load dataset
cell_bender_mat <- Read_CellBender_h5_Mat(file_name = "/Users/zackbrodtman/Documents/jobwork/CUIMC/JG02/LC/LC22/feature_bc_matrix_bent_filtered.h5")
...
new.cluster.ids <- c('Cardiomyocytes', 'Cardiomyocytes', 'dCAF', 'Fibroblasts', 'B Cells', 'Endothelial Cells','Other', 'Other')
...
### Save objects
saveRDS(seu, file = 'LC22_seu_processed.rds')

### write pdf reports
pdf(file = "LC22_plots.pdf")

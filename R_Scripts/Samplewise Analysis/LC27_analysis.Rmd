...
### Load dataset
cell_bender_mat <- Read_CellBender_h5_Mat(file_name = "/Users/zackbrodtman/Documents/jobwork/CUIMC/JG02/LC/LC27/feature_bc_matrix_bent_filtered.h5")
...
new.cluster.ids <- c('Plasma Cells', 'Memory B Cells', 'Plasma Cells', 'Fibroblasts','Cycling Endothelial Cells','Plasma Cells','Fibroblasts','Cardiomyocytes','Cycling Endothelial Cells', 'Cycling B Cells', 'Other',  'Endothelial')
...
### Save objects
saveRDS(seu, file = 'LC27_seu_processed.rds')

### write pdf reports
pdf(file = "LC27_plots.pdf")

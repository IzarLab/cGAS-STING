...
### Load dataset
cell_bender_mat <- Read_CellBender_h5_Mat(file_name = "/Users/zackbrodtman/Documents/jobwork/CUIMC/JG02/LC/LC24/feature_bc_matrix_bent_filtered.h5")
...
new.cluster.ids <- c('Cardiomyocytes', 'Cardiomyocytes', 'Myeloid', 'Endothelial Cells','myCAF','B Cells','myCAF','Other','Other', 'myCAF', 'Pericyte',  'Myeloid')
...
### Save objects
saveRDS(seu, file = 'LC24_seu_processed.rds')

### write pdf reports
pdf(file = "LC24_plots.pdf")
